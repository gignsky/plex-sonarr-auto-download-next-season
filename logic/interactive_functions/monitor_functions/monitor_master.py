...
def main(
    ...
    sonarr = SonarrAPI(base_url, api_key)
    ...
    # Set season to monitored and extract vars for episode monitoring
...
def check_vars(base_url, api_key, SONARR_SERIES_ID, season_number):
    ...
    Args:
        ...
        season_number (int): The season number of the episodes to be set to monitored
